const drawDeuda = async (m  = "Enero") => {
    let data = await d3.csv('datasetDeudaPublicaEspaña.csv', d3.autoType)
// Selectores (elementos en HTML)
const graf = d3.select("#grafDeuda")
const metrica = d3.select("#metricaDeuda")
...
const g = svg.append("g")
    ...
    const render = (m) => {
        ...
        //Titulo
        titulo.text("Deuda en el mes de "+ m )
        // Ejes
 ...
 const drawParados = async (m  = "Marzo") => {
    let data = await d3.csv('datasetParadosEspaña.csv', d3.autoType)
// Selectores (elementos en HTML)
const graf = d3.select("#grafParados")
const metrica = d3.select("#metricaParados")
...
const g = svg.append("g")
    ...
    const render = (m) => {
        ...
        //Titulo
        titulo.text("Comportamiento del desempleo en el trimestre a "+ m )
        // Ejes
        const xAxis = d3.axisBottom(x)        
        const yAxis = d3.axisLeft(y)
        xAxisGroup.transition().duration(2000).call(xAxis)
 ...
 drawall = () => {
    document.getElementById("grafDeuda").innerHTML = ""
	document.getElementById("grafParados").innerHTML = ""
    drawDeuda()
    drawParados()
  }
